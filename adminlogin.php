...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" type="" >   <!-- icon shown on top of heading of admin page -->
    <style>
...
<div class="wrapper fadeInDown">
    ...
    <div id="formContent">
      ...
      <div class="fadeIn first">
        <img src="https://i.pinimg.com/originals/6e/19/81/6e1981e45ddfa3b5bb2f44a6a196c99d.png" id="icon" alt="User Icon" />
      </div>
