...
<head>
    ...
    <title>FiestaEase-LITERARY</title>
        ...
        <div class="container">
            ...
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="assets/img/quiz.jpg"
                ...
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
                    ...
                    <p class="mb-3">What could have been better than books, text, novels, articles, blog, and hour-long discussions and debates?!
                        <h6><br><b>VENUE-</b><?php
...
<!-- second event -->
    <section class="page-section clearfix">
        <div class="container">
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="https://www.adl.org/sites/default/files/images/assets/images-content/education-outreach/curriculum-resources/election-debates-cartoon-candidates-bigstock-83348009-460.jpg"
                    style="width: 59%;">
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
