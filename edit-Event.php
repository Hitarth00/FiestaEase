    ...
    <div class="all-content-wrapper" >
        ...
        $tp=$_POST["tp"];
				...
				//if($name and $c and $t and $venue and $year and $start and $end and $begin and $close)
				{
					...
					//queries 
					$query_up = "UPDATE events SET event_name= '" .$name. "' ,category= '".$cat."' ,type= '".$type."' ,venue_id= '" .$venue."'  ,begin_time= '".$start."' ,end_time= '".$end."' ,begin_date= '".$begin."' ,end_date= '".$close."',first_prize='".$fp."',second_prize='".$sp."',third_prize='".$tp."' WHERE event_id = '".$id. "' ; "  ; 
