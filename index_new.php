...
<head>
    ...
    <title> Index Page | FiestaEase Admin </title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="">   <!-- icon shown on top of heading of admin page -->
    <!-- Google Fonts
		============================================ -->
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                ...
                <strong><a href="index_new.php"><img  src="https://i.pinimg.com/originals/6e/19/81/6e1981e45ddfa3b5bb2f44a6a196c99d.png" height = 300 width = 100 alt="Go to index page"/></a></strong>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="index_new.php">Home Page</a>
                                            </li>
                                            </li>
                                        </ul>
                                    </div>
