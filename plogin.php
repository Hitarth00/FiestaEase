...
<div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <div class="fadeIn first">
        <img src="https://logos.textgiraffe.com/logos/logo-name/33354540-designstyle-i-love-m.png" id="icon" alt="User Icon" />
      </div>
	  ...
	  <h5>Participant Login Form</h5>
		...
		<h6>Don't have Participant ID? Not registered yet?<br>
