        ...
        <div class="container">
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="assets/img/solodance.jpg"
                ...
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
                    ...
                    <p class="mb-3">Have passion for dance? Come show yourself @ Fiestaease!
                        <h6><br><b>VENUE-</b>
                            <?php
                                include "linc.php";
        ...
        <div class="container">
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="assets/img/groupdance.jpg"
                ...
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
                    ...
                    <p class="mb-3">Love Dancing in groups? Come to Fiestaease and engage all others to shake their body with you!
                        <h6><br><b>VENUE-</b> <?php
                                include "linc.php";
